...
require.config({
    paths: {
        ...
        VolatilitySetup: "../app/" + app_name + "/javascript/views/volatility_setup",
    },
});
...
require([
    ...
    // Custom files
    "VolatilitySetup",
], function(Backbone, jquery, VolatilitySetup) {
    var volatility_setup = new VolatilitySetup({
        // Sets the element that will be used for rendering
        el: jquery("#main_container"),
    });

    volatility_setup.render();
});
